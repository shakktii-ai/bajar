    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          ...
          <div className="mb-10">
            <h3 className="text-xl font-semibold text-green-700 mb-4 pb-2 border-b border-green-200">प्रशासकीय विभाग</h3>
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border border-gray-300">
                <thead>
                  <tr className="bg-green-700 text-white text-center">
                    <th className="py-3 px-4 border">अ.क्र</th>
                    <th className="py-3 px-4 border">अधिकारी / कर्मचारी नाव</th>
                ...
                <tbody>
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="py-3 px-4 border">मुकतार अब्बास शहा</td>
                  ...
                  <tr className="bg-gray-50">
                    <td className="py-3 px-4 border text-center">12</td>
                    <td className="py-3 px-4 border">तेजस शशिकांत जाधव</td>
                    <td className="py-3 px-4 border">वायरमन</td>
                  </tr>
                  <tr>
